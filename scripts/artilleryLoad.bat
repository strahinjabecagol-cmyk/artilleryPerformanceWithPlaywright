@echo off
REM ============================================
REM Artillery Load Test Runner + Local Report Viewer
REM ============================================
...
echo [2/5] Running Artillery load test...
call "%AppData%\npm\artillery.cmd" run "%PROJECT_ROOT%\artilleryLoad.yml" --output "%TEMP_RESULTS_DIR%\%RESULTS_FILE%" > "%TEMP_LOGS_DIR%\%LOG_FILE%" 2>&1
